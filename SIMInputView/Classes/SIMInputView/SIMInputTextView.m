...
#define InputUIColorFromRGBA(rgbValue , a) [UIColor colorWithRed:((CGFloat)((rgbValue & 0xFF0000) >> 16)) / 255.0 green:((CGFloat)((rgbValue & 0xFF00) >> 8)) / 255.0 blue:((CGFloat)(rgbValue & 0xFF)) / 255.0 alpha:a]


@implementation SIMInputTextView
#pragma mark - 生命周期 方法
- (void)dealloc
{
    _placeholder = nil;
...
- (void)setup
{
    ...
    _placeholderColor = InputUIColorFromRGBA(0x000000, 0.3);
    self.font = [UIFont systemFontOfSize:SIMInputViewFontValue];
...
- (void)paste:(id)sender
{
    ...
    // 2.添加属性
    [pastStr addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:SIMInputViewFontValue] range:NSMakeRange(0,pastStr.length)];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    if ([keyPath isEqualToString:@"contentSize"])
    {
        ...
        self.input_height = contentSize.height;
